...
<!-- Include Master.xsl to get all templates -->
...
<xsl:template name="getInstalledAddress">
	...
	<xsl:choose>
		<xsl:when test="$installedat='   ' or $installedat=''">
			<span class="pdf-text-8pt">Not Specified</span>
		</xsl:when>
		<xsl:otherwise>
			<span class="pdf-text-8pt"><xsl:value-of select="$installedat"/></span>
		</xsl:otherwise>
	</xsl:choose>
</xsl:template>
	...
	<xsl:choose>
		<xsl:when test="$assetType = 'Renew'">
			<div class="pdf-text-8pt">
				<span class="pdf-text-8pt-bold"><strong>Start Date of Extension:</strong></span>
				<span class="pdf-text-8pt">
			...
			<div class="pdf-text-8pt">
				<span class="pdf-text-8pt-bold"><strong>Extension Subscription End Date:</strong></span>
				<span class="pdf-text-8pt">
		...
		<xsl:when test="$assetType = 'Amend'">
			<div class="pdf-text-8pt">
				<span class="pdf-text-8pt-bold"><strong>Existing Subscription End Date:</strong></span>
				<span class="pdf-text-8pt">
					<xsl:call-template name="formatServiceEndDate">
						<xsl:with-param name="serviceEndDate" select="$lineItem/serviceEndDate_l_c"/>
					</xsl:call-template>
		...
		<xsl:otherwise>
			<div class="pdf-text-8pt">
				<span class="pdf-text-8pt-bold"><strong>Service Start Date:</strong></span>
				<span class="pdf-text-8pt">
					<xsl:call-template name="formatServiceStartDate">
						<xsl:with-param name="serviceStartDate" select="$lineItem/serviceStartDate_l_c"/>
					</xsl:call-template>
			...
			<div class="pdf-text-8pt">
				<span class="pdf-text-8pt-bold"><strong>Service End Date:</strong></span>
				<span class="pdf-text-8pt">
					<xsl:call-template name="formatServiceEndDate">
						<xsl:with-param name="serviceEndDate" select="$lineItem/serviceEndDate_l_c"/>
					</xsl:call-template>
			...
			<xsl:when test="$catCodeType = 'dynamic'">
				<xsl:choose>
					<xsl:when test="$dynamicCatCode != ''">
						<span class="pdf-text-8pt-bold"><strong>[ Discount Cat: </strong></span>
						<span class="pdf-text-8pt"><xsl:value-of select="$dynamicCatCode"/></span>
						<span class="pdf-text-8pt-bold"><strong> ]</strong></span>
					</xsl:when>
					<xsl:otherwise>
			...
			<xsl:when test="$catCodeType = 'legacy'">
				<xsl:choose>
					<xsl:when test="$legacyCatCode != ''">
						<span class="pdf-text-8pt-bold"><strong>[ Legacy Cat: </strong></span>
						<span class="pdf-text-8pt"><xsl:value-of select="$legacyCatCode"/></span>
						<span class="pdf-text-8pt-bold"><strong> ]</strong></span>
					</xsl:when>
					<xsl:otherwise>
...
<xsl:otherwise>
<xsl:value-of select="$_dsMain1/currency_t"/>
</xsl:otherwise>
</xsl:choose>
</xsl:template>
...
<xsl:with-param name="currency" select="$_dsMain1/currency_t"/>
</xsl:call-template>
</xsl:if>
</xsl:variable>
...
<!-- HTML versions of FO templates from Master.xsl -->
<xsl:template name="currencyFormattedPrice">
  <xsl:param name="price"/>
  <xsl:param name="align" select="'right'"/>
  <xsl:param name="fontSize" select="'12pt'"/>
...
.service-address { background-color: #f9f9f9; border-left: 3px solid #0070c0; padding: 8px; margin-bottom: 15px; }
...
<xsl:with-param name="dateString" select="substring($_dsMain1/quoteExportDate_t_c, 1, 10)"/>
</xsl:call-template>
</div>
</td>
...
<div class="margin-left-7pt">
<xsl:call-template name="formatDate">
<xsl:with-param name="dateString" select="substring($_dsMain1/expiresOnDate_t_c, 1, 10)"/>
</xsl:call-template>
</div>
</td>
</tr>
...
<td class="pdf-table-cell pdf-text-8pt">
<div class="margin-left-7pt">
<xsl:value-of select="$_dsMain1/_commerce_array_set_attr_info[@setName='accounts_Array_t_c']/_array_set_row[@_row_number='2']/attribute[@var_name='company_accounts_Array_t_c']"/><br/>
<xsl:value-of select="$_dsMain1/_commerce_array_set_attr_info[@setName='accounts_Array_t_c']/_array_set_row[@_row_number='2']/attribute[@var_name='address_accounts_Array_t_c']"/>
</div>
</td>
<td class="pdf-table-cell pdf-text-right pdf-text-8pt">Quote Status:</td>
<td class="pdf-table-cell pdf-text-8pt">
<div class="margin-left-7pt">
<xsl:value-of select="$_dsMain1/quoteStatus_t_c"/>
</div>
</td>
</tr>
<tr>
<td class="pdf-table-cell pdf-text-right pdf-text-8pt">Quote From:</td>
<td class="pdf-table-cell pdf-text-8pt" colspan="3">
<div class="margin-left-7pt">
<xsl:value-of select="$_dsMain1/legalEntities_t_c"/>
,
<xsl:value-of select="$_dsMain1/legalEntityAddress_t_c"/>
</div>
</td>
</tr>
<tr>
<td class="pdf-table-cell pdf-text-right pdf-text-8pt">
<xsl:choose>
...
<xsl:variable name="accountsJson" select="$_dsMain1/accountsJsonArray_t_c"/>
...
<td class="pdf-table-cell-bordered pdf-text-center pdf-text-8pt">
<xsl:choose>
...
<xsl:if test="$COLUMN97146a5d-d8d0-43a1-9c13-84344296d864='true'">
<td class="pdf-table-cell pdf-currency">
...
<!--  Renewal Totals Row - Mirroring Master.xsl logic (Net Price only)  -->
<tr>
<td class="table-cell text-right section-header" colspan="6">Renewals Grand Total:</td>
...
<!--  Total Ext. Net Price only (matching Master.xsl)  -->
<td class="pdf-table-cell pdf-currency pdf-text-8pt-bold">
<xsl:variable name="extNetPrice">
<xsl:choose>
<xsl:when test="$pricingTier = '1' or $pricingTier = ''">
...
<!--  Detailed Section Header - Conditional to match Master.xsl logic  -->
<xsl:if test="//simplifiedPrinting_l_c='true' and $_dsMain1/keyStone_t_c != 'Yes' and $_dsMain1/serviceRenewal_t_c != '100% Renewals'">
<div class="section-break">
<div class="pdf-section-header" style="font-weight: bold; font-size: 14pt; margin: 20px 0;">Detailed Section</div>
</div>
</xsl:if>
<!--  Product Details Header - Mirroring FO section structure  -->
<div class="section-break">
<div class="pdf-section-header">Product Details</div>
...
<xsl:for-each select="/transaction/data_xml/document[normalize-space(./@data_type)='3' and ./renewalIndicator_l_c = 'Y' and (./lineType_l = 'SERVICE' or starts-with(./item_l/_part_number, 'CS-')) and ./doNotPrintFlag_l_c != 'Y']">
<xsl:sort select="./@_document_number" data-type="number" order="ascending"/>
<!--  Get parent MODEL line using modelReferenceLineID_l_c  -->
<xsl:variable name="modelReferenceID" select="./modelReferenceLineID_l_c"/>
<xsl:variable name="parentMODEL" select="exsl:node-set(/transaction/data_xml/document[ normalize-space(./@data_type)='3' and ./lineType_l = 'MODEL' and ./lineItemNumber_l_c = $modelReferenceID ])"/>
<!--  Get the MODEL line with service period data (may be data_type='2')  -->
<xsl:variable name="servicePeriodMODEL" select="exsl:node-set(/transaction/data_xml/document[ ./lineType_l = 'MODEL' and ./virtualConfigName_l_c = $parentMODEL/virtualConfigName_l_c ])"/>
...
<div class="pdf-section-header">NetApp Services</div>
</div>
<!--  Config ID  -->
<div class="section-header section-break">
Config#<xsl:value-of select="$configID"/>
<xsl:if test="$parentMODEL/virtualConfigName_l_c and $parentMODEL/virtualConfigName_l_c != ''">
 - <xsl:value-of select="$parentMODEL/virtualConfigName_l_c"/>
</xsl:if>
</div>

<!--  Service Address Section  -->
<xsl:if test="$parentMODEL/installedAt or ../installedAt">
<div style="font-size: 10pt; margin-bottom: 10px; padding: 5px; background-color: #f9f9f9; border-left: 3px solid #0070c0;">
<strong>Service Address:</strong><br/>
<xsl:choose>
  <xsl:when test="$parentMODEL/installedAt">
    <xsl:value-of select="$parentMODEL/installedAt/name"/><br/>
    <xsl:if test="$parentMODEL/installedAt/street">
      <xsl:value-of select="$parentMODEL/installedAt/street"/><br/>
    </xsl:if>
    <xsl:if test="$parentMODEL/installedAt/city or $parentMODEL/installedAt/state or $parentMODEL/installedAt/postalCode">
      <xsl:value-of select="$parentMODEL/installedAt/city"/>
      <xsl:if test="$parentMODEL/installedAt/city and $parentMODEL/installedAt/state">, </xsl:if>
      <xsl:value-of select="$parentMODEL/installedAt/state"/>
      <xsl:if test="$parentMODEL/installedAt/postalCode"> <xsl:value-of select="$parentMODEL/installedAt/postalCode"/></xsl:if>
      <br/>
    </xsl:if>
    <xsl:if test="$parentMODEL/installedAt/country">
      <xsl:value-of select="$parentMODEL/installedAt/country"/>
    </xsl:if>
  </xsl:when>
  <xsl:when test="../installedAt">
    California United States 95014
  </xsl:when>
</xsl:choose>
</div>
</xsl:if>
...
<div class="pdf-section-header">Services</div>
<!--  Show 'Estimated' only if PVR not approved  -->
<xsl:variable name="pvrStatus" select="$_dsMain1/pvrStatus_t_c"/>
...
<xsl:variable name="catCodesMode" select="$_dsMain1/catCodes_t_c"/>
<xsl:choose>
<!--  Dynamic Cat Code Mode  -->
<xsl:when test="$catCodesMode = 'dynamic'">
<xsl:variable name="serviceLines" select="exsl:node-set(/transaction/data_xml/document[ normalize-space(./@data_type)='3' and ./cPQVirtualPart_l_c = 'CSITEMCHILD' and ./modelReferenceLineID_l_c = ./lineItemNumber_l_c ])"/>
...
<xsl:variable name="childLines" select="exsl:node-set(/transaction/data_xml/document[ normalize-space(./@data_type)='3' and (./lineItemNumber_l_c = ./modelReferenceLineID_l_c or ./item_l/_part_number = ./coveredItem_l_c) and ./virtualLineID_l_c = ./virtualLineID_l_c ])"/>
...
<xsl:for-each select="/transaction/data_xml/document[normalize-space(./@data_type)='3' and ./lineType_l = 'MODEL' and ./item_l/_part_number = 'SES-SYSTEM']">
<xsl:sort select="./@_document_number" data-type="number" order="ascending"/>
<xsl:variable name="lineItemNumber" select="./lineItemNumber_l_c"/>
<xsl:variable name="childServiceLines" select="exsl:node-set(/transaction/data_xml/document[ normalize-space(./@data_type)='3' and ./modelReferenceLineID_l_c = $lineItemNumber and (./lineType_l = 'SERVICE' or starts-with(./item_l/_part_number, 'CS-')) and ./doNotPrintFlag_l_c != 'Y' ])"/>
...
<xsl:for-each select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and lineType_l='MODEL' and doNotPrintFlag_l_c != 'Y' and (extendedListPrice_l_c != '0.0' or extendedNetPrice_l_c != '0.0')]">
...
<xsl:if test="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='2' and cPQVirtualPart_l_c='SUBROOT' and _document_number = current()/_parent_doc_number]">
<!--  Get the parent SUBROOT's config name for this MODEL  -->
<xsl:variable name="parentSubroot" select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='2' and cPQVirtualPart_l_c='SUBROOT' and _document_number = current()/_parent_doc_number]"/>
<xsl:variable name="virtualLineID" select="$parentSubroot/virtualLineID_l_c"/>
<xsl:variable name="parentConfigName" select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='2' and cPQVirtualPart_l_c='ROOT' and virtualLineID_l_c=$virtualLineID]/virtualConfigName_l_c"/>
...
<xsl:variable name="platformLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and (summaryPrintGrouping_l_c='Platform' or summaryPrintGrouping_l_c='PLATFORM') and summaryPrint_l_c='Y'])"/>
<xsl:variable name="capacityLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and summaryPrintGrouping_l_c='Capacity' and summaryPrint_l_c='Y'])"/>
<xsl:variable name="networkingLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and (summaryPrintGrouping_l_c='Networking' or summaryPrintGrouping_l_c='Network Adapters') and summaryPrint_l_c='Y'])"/>
<xsl:variable name="switchesLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and summaryPrintGrouping_l_c='Switches' and summaryPrint_l_c='Y'])"/>
<xsl:variable name="BridgesLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and summaryPrintGrouping_l_c='Bridges' and summaryPrint_l_c='Y'])"/>
<xsl:variable name="SoftwareLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and summaryPrintGrouping_l_c='Software' and summaryPrint_l_c='Y'])"/>
<xsl:variable name="subscriptionLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and summaryPrintGrouping_l_c='SUBSCRIPTION' and summaryPrint_l_c='Y'])"/>
<xsl:variable name="otherserviceLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and (summaryPrintGrouping_l_c='SERVICES' or summaryPrintGrouping_l_c='Services') and summaryPrint_l_c='Y'])"/>
<xsl:variable name="AddserviceLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and summaryPrintGrouping_l_c='Additional Service' and summaryPrint_l_c='Y'])"/>
<xsl:variable name="ProfserviceLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and summaryPrintGrouping_l_c='Professional Services' and summaryPrint_l_c='Y'])"/>
<xsl:variable name="dataNodesLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and summaryPrintGrouping_l_c='Data Compute Node' and summaryPrint_l_c='Y'])"/>
<!--  Price grouping lines (for aggregating prices) using direct XPath  -->
<xsl:variable name="platformpriceLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and (summaryPriceGrouping_l_c='Platform' or summaryPriceGrouping_l_c='PLATFORM' or (summaryPriceGrouping_l_c='' and summaryPrintGrouping_l_c='Platform') or (summaryPriceGrouping_l_c='' and summaryPrintGrouping_l_c='PLATFORM'))])"/>
<xsl:variable name="capacitypriceLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and (summaryPriceGrouping_l_c='Capacity' or (summaryPriceGrouping_l_c='' and summaryPrintGrouping_l_c='Capacity'))])"/>
<xsl:variable name="networkingpricesLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and (summaryPriceGrouping_l_c='Networking' or summaryPriceGrouping_l_c='Network Adapters' or (summaryPriceGrouping_l_c='' and summaryPrintGrouping_l_c='Networking') or (summaryPriceGrouping_l_c='' and summaryPrintGrouping_l_c='Network Adapters'))])"/>
<xsl:variable name="switchespricesLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and (summaryPriceGrouping_l_c='Switches' or (summaryPriceGrouping_l_c='' and summaryPrintGrouping_l_c='Switches'))])"/>
<xsl:variable name="BridgespricesLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and (summaryPriceGrouping_l_c='Bridges' or (summaryPriceGrouping_l_c='' and summaryPrintGrouping_l_c='Bridges'))])"/>
<xsl:variable name="SoftwarepriceLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and (summaryPriceGrouping_l_c='Software' or summaryPriceGrouping_l_c='SOFTWARE' or (summaryPriceGrouping_l_c='' and summaryPrintGrouping_l_c='Software') or (summaryPriceGrouping_l_c='' and summaryPrintGrouping_l_c='SOFTWARE'))])"/>
<xsl:variable name="subscriptionpriceLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and (summaryPriceGrouping_l_c='SUBSCRIPTION' or (summaryPriceGrouping_l_c='' and summaryPrintGrouping_l_c='SUBSCRIPTION'))])"/>
<xsl:variable name="otherservicepriceLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and (summaryPriceGrouping_l_c='SERVICES' or summaryPriceGrouping_l_c='Services' or (summaryPriceGrouping_l_c='' and summaryPrintGrouping_l_c='SERVICES') or (summaryPriceGrouping_l_c='' and summaryPrintGrouping_l_c='Services'))])"/>
<xsl:variable name="AddservicepriceLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and (summaryPriceGrouping_l_c='Additional Service' or (summaryPriceGrouping_l_c='' and summaryPrintGrouping_l_c='Additional Service'))])"/>
<xsl:variable name="ProfservicepriceLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and (summaryPriceGrouping_l_c='Professional Services' or (summaryPriceGrouping_l_c='' and summaryPrintGrouping_l_c='Professional Services'))])"/>
<xsl:variable name="dataNodespriceLines" select="exsl:node-set(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and topModelLineID_l_c=$lineNumber and lineType_l!='MODEL' and cPQVirtualPart_l_c!='CSITEMCHILD' and bundleChild_l_c='false' and (summaryPriceGrouping_l_c='Data Compute Node' or (summaryPriceGrouping_l_c='' and summaryPrintGrouping_l_c='Data Compute Node'))])"/>
<!--  System Group Box  -->
<div class="pdf-section-header">
<div class="pdf-section-header">
<xsl:choose>
...
<div class="pdf-section-header" style="margin-top: 20px; margin-bottom: 20px;">
<h3 class="pdf-section-header" style="background-color: #E1E1E1; padding: 8px; border: 1px solid #949494; margin-bottom: 10px;">
Detailed Line Items
</h3>
...
<xsl:for-each select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and _parent_doc_number = $rootDocNumber and lineType_l != 'MODEL' and doNotPrintFlag_l_c != 'Y' and (extendedListPrice_l_c != '0.0' or extendedNetPrice_l_c != '0.0')]">
<xsl:sort select="./@_document_number" order="ascending"/>
<tr>
...
<xsl:for-each select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='2' and cPQVirtualPart_l_c='SUBROOT']">
...
<div class="pdf-section-header" style="margin-top: 30px;">
...
<!--  Master.xsl Logic: Show detailed section ONLY when simplifiedPrinting_l_c='true' AND KeyStone!='Yes' AND serviceRenewal!='100% Renewals'  -->
<xsl:if test="//simplifiedPrinting_l_c='true' and $_dsMain1/keyStone_t_c != 'Yes' and $_dsMain1/serviceRenewal_t_c != '100% Renewals'">
<div class="pdf-section-header" style="margin-top: 30px; margin-bottom: 20px;">
<h2 style="font-size: 16px; font-weight: bold;">Detailed Section</h2>
</div>
<!--  Loop through each ROOT config to get Config ID  -->
<xsl:for-each select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='2' and (_parent_doc_number = '' or cPQVirtualPart_l_c='ROOT' or cPQVirtualPart_l_c='SUBROOT')]">
...
<xsl:variable name="smplines" select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and _parent_doc_number = ./_document_number and oRCL_ABO_ActionCode_l != 'DELETE' and downstreamFulfillment_l_c = 'SMP']"/>
<xsl:variable name="serviceDuration">
<xsl:choose>
...
<xsl:for-each select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and _parent_doc_number = ./_document_number and lineType_l = 'MODEL' and doNotPrintFlag_l_c != 'Y' and (extendedListPrice_l_c != '0.0' or extendedNetPrice_l_c != '0.0')]">
<xsl:sort select="./@_document_number" order="ascending"/>
<xsl:variable name="lineNumber" select="./lineItemNumber_l_c"/>
<xsl:variable name="bom_level" select="./_line_bom_level"/>
...
<xsl:variable name="allComponentLines" select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and (topModelLineID_l_c = $lineNumber or (modelReferenceLineID_l_c = $lineNumber and _line_bom_level > $bom_level)) and lineType_l != 'MODEL' and cPQVirtualPart_l_c != 'CSITEMCHILD' and doNotPrintFlag_l_c != 'Y' and bundleChild_l_c = 'false']"/>
...
<xsl:when test="number($cond_summary_view)=1">
  ...
  <div class="pdf-text-8pt" style="margin-top: 10px;">
...
<div class="pdf-section-header" style="margin: 15px 0; font-weight: bold; font-size: 9pt;">
<table>
<tr class="bg-mg">
<td style="width: 20%;">
...
<xsl:variable name="rootDocWithAddress" select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='2' and (_parent_doc_number = '' or cPQVirtualPart_l_c='ROOT' or cPQVirtualPart_l_c='SUBROOT') and installedAtAddress_l_c != ''][1]"/>
...
<!--  System Details Section - Missing from Child.xsl  -->
<div style="margin-top: 20px;">
<table style="width: 100%; border-collapse: collapse; margin-top: 5px;">
<thead>
<tr style="background-color: #f0f0f0;">
<th style="border: 1px solid #949494; padding: 8px; font-weight: bold; font-size: 8pt;">System Details: Product</th>
<th style="border: 1px solid #949494; padding: 8px; font-weight: bold; font-size: 8pt;">Qty</th>
<th style="border: 1px solid #949494; padding: 8px; font-weight: bold; font-size: 8pt;">EOSL Date</th>
</tr>
</thead>
<tbody>
<xsl:for-each select="$allComponentLines[printGrouping_l_c = 'HARDWARE' or printGrouping_l_c = 'PLATFORM' or printGrouping_l_c = 'STORAGE']">
<tr>
<td style="border: 1px solid #949494; padding: 4px; font-size: 8pt;">
<xsl:value-of select="item_l/_model_name"/>
<xsl:if test="item_l/_model_name = ''">
<xsl:value-of select="item_l/_part_display_name"/>
</xsl:if>
</td>
<td style="border: 1px solid #949494; padding: 4px; text-align: center; font-size: 8pt;">
<xsl:value-of select="extendedQuantity_l_c"/>
</td>
<td style="border: 1px solid #949494; padding: 4px; text-align: center; font-size: 8pt;">
<xsl:choose>
<xsl:when test="eOSLDate_l_c != ''">
<xsl:value-of select="substring(eOSLDate_l_c, 9, 2)"/>/<xsl:value-of select="substring(eOSLDate_l_c, 6, 2)"/>/<xsl:value-of select="substring(eOSLDate_l_c, 1, 4)"/>
</xsl:when>
<xsl:otherwise>-</xsl:otherwise>
</xsl:choose>
</td>
...
<p style="font-size: 8pt; margin-top: 5px;">Please see the quote footer for additional information on EOS limitations.</p>
</div>

<!--  Service Details Section - Missing from Child.xsl  -->
<xsl:if test="count($serviceLines) > 0">
<div style="margin-top: 20px;">
<table style="width: 100%; border-collapse: collapse; margin-top: 5px;">
<thead>
<tr style="background-color: #f0f0f0;">
<th style="border: 1px solid #949494; padding: 8px; font-weight: bold; font-size: 8pt;">Service Details</th>
<th style="border: 1px solid #949494; padding: 8px; font-weight: bold; font-size: 8pt;">Qty</th>
<th style="border: 1px solid #949494; padding: 8px; font-weight: bold; font-size: 8pt;">Service Start Date</th>
<th style="border: 1px solid #949494; padding: 8px; font-weight: bold; font-size: 8pt;">Service End Date</th>
<th style="border: 1px solid #949494; padding: 8px; font-weight: bold; font-size: 8pt;">Duration</th>
</tr>
</thead>
<tbody>
...
<td style="border: 1px solid #949494; padding: 4px; text-align: center; font-size: 8pt;">
<xsl:choose>
<xsl:when test="serviceStartDate_l_c != ''">
<xsl:value-of select="substring(serviceStartDate_l_c, 9, 2)"/>-<xsl:value-of select="substring(serviceStartDate_l_c, 6, 2)"/>-<xsl:value-of select="substring(serviceStartDate_l_c, 1, 4)"/>
</xsl:when>
<xsl:otherwise>-</xsl:otherwise>
</xsl:choose>
</td>
<td style="border: 1px solid #949494; padding: 4px; text-align: center; font-size: 8pt;">
<xsl:choose>
<xsl:when test="serviceEndDate_l_c != ''">
<xsl:value-of select="substring(serviceEndDate_l_c, 9, 2)"/>-<xsl:value-of select="substring(serviceEndDate_l_c, 6, 2)"/>-<xsl:value-of select="substring(serviceEndDate_l_c, 1, 4)"/>
</xsl:when>
<xsl:otherwise>-</xsl:otherwise>
</xsl:choose>
</td>
<td style="border: 1px solid #949494; padding: 4px; text-align: center; font-size: 8pt;">
<xsl:value-of select="serviceDuration_l_c"/>
<xsl:if test="serviceDuration_l_c != ''"> Months</xsl:if>
</td>
</tr>
</xsl:for-each>
</tbody>
...
<xsl:for-each select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and downstreamFulfillment_l_c = 'SMP' and lineType_l = 'MODEL' and doNotPrintFlag_l_c != 'Y']">
<xsl:sort select="./@_document_number" order="ascending"/>
...
<xsl:for-each select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and _parent_doc_number = ./_document_number and downstreamFulfillment_l_c = 'SMP' and _parent_doc_number = $smpLineNumber]">
<xsl:sort select="./@_document_number" order="ascending"/>
...
<div class="pdf-section-header" style="margin: 20px 0;">
...
<xsl:for-each select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and _parent_doc_number = ./_document_number and downstreamFulfillment_l_c != 'SMP' and _parent_doc_number = $nonSmpLineNumber]">
<xsl:sort select="./@_document_number" order="ascending"/>
...
<xsl:if test="(/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='2' and downstreamFulfillment_l_c = 'SMP' and renewalIndicator_l_c!='Y' and $_dsMain1/keyStone_t_c!='Yes'])">
<div class="pdf-section-header" style="margin-top: 30px; margin-bottom: 20px;">
<h2 style="font-size: 16pt; font-weight: bold; margin-bottom: 15px; page-break-before: auto;">Detailed Section</h2>

<xsl:for-each select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='2' and downstreamFulfillment_l_c = 'SMP' and renewalIndicator_l_c!='Y' and $_dsMain1/keyStone_t_c!='Yes' and ((_parent_doc_number = '' and cPQVirtualPart_l_c != 'ROOT') or cPQVirtualPart_l_c = 'SUBROOT')]">
<xsl:sort select="./@_document_number" order="ascending"/>
...
<div class="pdf-section-header" style="margin-top: 20px; margin-bottom: 10px;">
...
<xsl:for-each select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and _parent_doc_number = $proposalLoopDocNumber and oRCL_ABO_ActionCode_l != 'DELETE' and downstreamFulfillment_l_c = 'SMP']">
<xsl:sort select="./@_document_number" order="ascending"/>
<tr>
...
<xsl:choose>
<xsl:when test="cPQVirtualPart_l_c='SUBROOT'">
<xsl:value-of select="/transaction/data_xml/document[@document_var_name='transactionLine' and _document_number = $parentLoopDocNumber]/simplifiedPrinting_l_c"/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="./simplifiedPrinting_l_c"/>
</xsl:otherwise>
...
<div class="pdf-text-8pt" style="margin-top: 15px;">
<xsl:for-each select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and _parent_doc_number = $proposalLoopDocNumber and downstreamFulfillment_l_c != 'SMP']">
<xsl:sort select="./@_document_number" order="ascending"/>
...
<div class="pdf-section-header" style="margin: 20px 0 10px 0; padding: 10px; background-color: #f5f5f5; border-bottom: 1px solid #ccc;">
...
<xsl:variable name="allSubLines" select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and (topModelLineID_l_c = $lineNumber or ((modelReferenceLineID_l_c = $lineNumber or serviceReferenceLineID_l_c = $lineNumber) and _line_bom_level > $bom_level)) and lineType_l != 'MODEL']"/>
...
<xsl:if test="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='2' and downstreamFulfillment_l_c != 'SMP' and renewalIndicator_l_c = 'Y']">
<div class="pdf-section-header" style="margin-top: 30px; margin-bottom: 20px;">
<h2 style="font-size: 16pt; font-weight: bold; margin-bottom: 15px; page-break-before: auto;">Non-SMP Renewal Services</h2>

<xsl:for-each select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='2' and downstreamFulfillment_l_c != 'SMP' and renewalIndicator_l_c = 'Y']">
<xsl:sort select="./@_document_number" order="ascending"/>
<xsl:variable name="proposalLoopDocNumber" select="./_document_number"/>
<xsl:variable name="parentLoopDocNumber" select="./_parent_doc_number"/>
<xsl:variable name="parentConfigName" select="./virtualConfigName_l_c"/>
...
<xsl:for-each select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and (_parent_doc_number = $proposalLoopDocNumber or _parent_doc_number = $parentLoopDocNumber) and downstreamFulfillment_l_c != 'SMP' and renewalIndicator_l_c = 'Y' and lineType_l != 'STD']">
<xsl:sort select="./@_document_number" order="ascending"/>
<xsl:variable name="modelLoopDocNumber" select="./_document_number"/>
<xsl:variable name="lineNumber" select="./lineItemNumber_l_c"/>
...
<xsl:for-each select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='2' and $_dsMain1/keyStone_t_c='Yes' and _parent_doc_number = '']">
<xsl:sort select="./@_document_number" order="ascending"/>
<xsl:variable name="proposalLoopDocNumber" select="./_document_number"/>
<xsl:variable name="excludingOneTimeFeeLines" select="/transaction/data_xml/document[@document_var_name='transactionLine' and normalize-space(./@data_type)='3' and _parent_doc_number = $proposalLoopDocNumber and not(summaryPrintGrouping_l_c = 'One Time Fee' or summaryPrintGrouping_l_c = 'Add-on Service-One Time Fee' or summaryPrintGrouping_l_c = 'One-Time Charge')]"/>
...
<xsl:for-each select="$_dsMain1/_commerce_array_set_attr_info[@setName='discountSummary_Array_t_c']/_array_set_row">
<xsl:if test="attribute[@var_name='discountType_discountSummary_Array_t_c'] = 'Promotional Discount'">true</xsl:if>
</xsl:for-each>
</xsl:variable>
<xsl:if test="contains($hasPromotionalDiscount, 'true') or $_dsMain1/storageEfficiencyGuarantee_t_c='true' or count($_dsMain1/_commerce_array_set_attr_info[@setName='promo_Array_t_c']/_array_set_row[attribute[@var_name='promoDescription_promo_Array_t_c']!='']) > 0">
...
<xsl:if test="$_dsMain1/storageEfficiencyGuarantee_t_c='true'">
...
<xsl:for-each select="$_dsMain1/_commerce_array_set_attr_info[@setName='promo_Array_t_c']/_array_set_row">
<xsl:sort select="./@_row_number" data-type="number" order="ascending"/>
...
<div class="pdf-text-8pt" style="margin-top: 40px;">
...
<td>
<xsl:value-of select="$_dsMain1/_commerce_array_set_attr_info[@setName='accounts_Array_t_c']/_array_set_row[@_row_number='2']/attribute[@var_name='company_accounts_Array_t_c']"/>
,
<xsl:value-of select="$_dsMain1/_commerce_array_set_attr_info[@setName='accounts_Array_t_c']/_array_set_row[@_row_number='2']/attribute[@var_name='address_accounts_Array_t_c']"/>
</td>
<td/>
...
<td>
<xsl:value-of select="$_dsMain1/shipTo_t/_shipTo_t_company_name"/>
<xsl:text>, </xsl:text>
<xsl:value-of select="$_dsMain1/shipTo_t/_shipTo_t_address"/>
<xsl:text> </xsl:text>
<xsl:value-of select="$_dsMain1/shipTo_t/_shipTo_t_city"/>
<xsl:text> </xsl:text>
<xsl:value-of select="$_dsMain1/shipTo_t/_shipTo_t_state"/>
<xsl:text> </xsl:text>
<xsl:value-of select="$_dsMain1/shipTo_t/_shipTo_t_country"/>
<xsl:text> </xsl:text>
<xsl:value-of select="$_dsMain1/shipTo_t/_shipTo_t_zip"/>
</td>
<td/>
<td/>
</tr>
...
<td>
<xsl:value-of select="$_dsMain1/softwareDeliveryContact_t_c"/>
</td>
<td/>
<td/>
</tr>
...
<td>
<xsl:value-of select="$_dsMain1/softwareDeliveryEmail_t_c"/>
</td>
<td/>
<td/>
</tr>
...
<td>
<xsl:choose>
<xsl:when test="$_dsMain1/incoterm_t_c/@display_value">
<xsl:value-of select="$_dsMain1/incoterm_t_c/@display_value"/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="$_dsMain1/incoterm_t_c"/>
</xsl:otherwise>
</xsl:choose>
</td>
<td>Quote Status:</td>
...
<td>
<xsl:value-of select="$_dsMain1/fulfillmentMethod_t_c"/>
</td>
<td/>
<td/>
</tr>
...
<td>
<xsl:value-of select="$_dsMain1/apttusAgreementNumber_t_c"/>
</td>
<td>Contingency:</td>
<td>None</td>
</tr>
...
<td>Order Type:</td>
<td>
<xsl:value-of select="$_dsMain1/orderType_t_c"/>
</td>
<td>Contract Name:</td>
<td>
<xsl:value-of select="$_dsMain1/agreementName_t_c"/>
</td>
</tr>
<tr>
<td>Payment Terms:</td>
<td>
<xsl:value-of select="$_dsMain1/paymentTerms_t_c"/>
</td>
<td/>
<td/>
</tr>
...
<h3 class="pdf-section-header">Terms and Conditions</h3>
<p class="pdf-text-8pt"> This quote is presented for budgetary purposes only. All net prices and discounts are estimated values only and are subject to change. A budgetary quote cannot be used as the basis for valid purchase order. </p>
</div>
<!--  Footer Information  -->
...
<xsl:value-of select="$_dsMain1/priceList_t_c"/>
<xsl:text> | Date Printed: </xsl:text>
<xsl:value-of select="substring($_dsMain1/quoteExportDate_t_c, 1, 10)"/>
</p>
</div>
...
<xsl:variable name="currency" select="$_dsMain1/currency_t"/>
